...
namespace MBS
{
    public class WUBInventory : MBSSingleton<WUBInventory>
    {
        ...
        private void Awake() => WULogin.OnLoggedIn += OnLoggedIn;

        #region Loading and saving
        void OnLoggedIn(CML _) => LoadInventory();
        void LoadInventory() => Inventory.Load(SaveFileName);
        /// <summary>
        /// Save the entire inventory to disk
        /// </summary>
        static public void SaveInventory() => Inventory.Save(SaveFileName);
        ...
        static public void SaveInventoryOnline(Action<CML> OnSuccess = null, Action<CMLData> OnFailed = null)
        {
        ...
        static public void LoadInventoryFromOnline(Action<CMLData> OnFail = null) => WUData.FetchField(OnlineSaveFieldName, SaveFileName, ParseResponse, errorResponse: OnFail ?? HandleErrorWhileFetching);
        ...
        static void ParseResponse(CML response)
        {
        ...
        static void HandleErrorWhileFetching(CMLData response)
        {
            Inventory = new CML();
        ...
        /// <summary>
        /// Sets item quantity to a specific amount
        /// </summary>
        /// <param name="name">Inventory item to set</param>
        /// <param name="qty">New value</param>
        /// <returns>NULL if <e>qty</e> <= 0 and negative values not allowed, FALSE if negative and negative values are not allowed. TRUE upon successful subtraction </returns>
        static public bool? SetItemQuantity(string name, long qty)
        {
